...
const descripcionesCategorias: Record<string, string> = {
  "Todos": "Explora todos los artículos de nuestro blog, desde recetas de repostería hasta consejos de decoración, pensados para endulzar tu vida.",
  "Repostería": "Artículos sobre técnicas de repostería, ingredientes de calidad y cómo crear postres perfectos que sorprendan a todos.",
  "Recetas": "Inspírate con recetas dulces y deliciosas que puedes preparar en casa. ¡Postres que te harán sentir especial!",
  "Decoración": "Conoce las últimas tendencias en decoración de tortas y pasteles, técnicas profesionales y consejos para hacer tus creaciones únicas."
};

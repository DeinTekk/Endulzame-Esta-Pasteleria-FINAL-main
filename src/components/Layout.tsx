      ...
      <Navbar expand="lg" className="shadow-sm barra-navegacion">
        <div className="container">
          <Navbar.Brand as={Link} to="/" className="d-flex align-items-center gap-2">
            <img src="/img/logo.jpg" alt="Endúlzame esta" className="imagen-logo" />
            <span style={{ fontFamily: "'Playfair Display', serif", color: 'var(--color-secundario)', fontWeight: 700 }}>Endúlzame esta</span>
          </Navbar.Brand>
